...
export const Header: React.FC = () => {
  ...
  const getNavLinkClass = (sectionId: string) => {
    return activeSection === sectionId ? "header__nav-link header__nav-link--active" : "header__nav-link";
  };
      ...
      <nav className="header__nav">
        <ul className="header__nav-list">
          <li className="header__nav-item">
            <a href="#home" onClick={e => handleNavClick('home', e)} className={getNavLinkClass('home')}>HOME</a>
          </li>
          <li className="header__nav-item">
            <a href="#work" onClick={e => handleNavClick('work', e)} className={getNavLinkClass('work')}>WORK</a>
          </li>
          <li className="header__nav-item">
            <a href="#about" onClick={e => handleNavClick('about', e)} className={getNavLinkClass('about')}>ABOUT</a>
          </li>
        </ul>
      </nav>
    </header>
